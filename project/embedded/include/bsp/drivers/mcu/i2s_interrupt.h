...
/* Macros                                                                                                             */
/**********************************************************************************************************************/
#define CREATE_I2S_INTERRUPT_DRIVER(idx)                                                                               \
    ...
    {                                                                                                                  \
        return i2s_driver_get_rx_count(&i2s_##idx##_resources);                                                        \
                                                                                                                       ...
                                                                                                                       \
    static int32_t _i2s_##idx##_driver_control(uint32_t control, uint32_t arg, uint32_t another_arg)                   \
    {                                                                                                                  \
        return i2s_driver_control(&i2s_##idx##_resources, control, arg, another_arg);                                  \
    }                                                                                                                  \
                                                                                                                       \
    ...
    {                                                                                                                  \
        i2s_driver_rx_irq_handler(&i2s_##idx##_resources);                                                             \
    }                                                                                                                  \
                                                                                                                       \
    void USART##idx##_TX_IRQHandler(void)                                                                              \
    {                                                                                                                  \
        i2s_driver_tx_irq_handler(&i2s_##idx##_resources);                                                             \
    }                                                                                                                  \
